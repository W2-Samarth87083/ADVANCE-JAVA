...
public class JdbcBookshopMain {
	public static void main(String[] args) {
		/*
		// input values from user and then set in book object
		Book b = new Book(43, "UNIX INTERNALS", "URESH", "OS", 544.20);
		...
		*/
		...
		try(CustomerDao custDao = new CustomerDao()) {
			Customer c = custDao.findByEmail("nilesh@sunbeaminfo.com");
			if(c != null)
